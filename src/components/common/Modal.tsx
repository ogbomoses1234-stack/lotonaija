...
/**
 * Centered modal dialog – light theme.
 * White background, dark text, subtle border and shadow.
 * Mobile-optimized with focus trap and accessibility support.
 */
  ...
  ({
    ...
    return createPortal(
      ...
      >
        <div
          className={cn(
            'bg-white border border-gray-200 shadow-lg w-full',
            sizeClasses[size],
            'rounded-3xl p-4 max-h-[90vh] overflow-y-auto',
            'animate-slide-up',
            className,
          )}
