...
/**
 * Material 3‑style progress bar – light theme.
 * Uses brand colours on a grey track with dark labels.
 */
export const ProgressBar = memo(({
  ...
  const variantClasses = {
    ...
    accent: 'bg-brand-primary',   // accent maps to brand‑primary in light theme
